...
public class FreeSubscription extends Subscription {
    ...
    // Constructs a new FreeSubscription object with the name "Free" by
    // calling the constructor of the superclass Subscription.
    ...
    // Gets the nth digit of a given number, starting from the rightmost digit as the 0th digit
